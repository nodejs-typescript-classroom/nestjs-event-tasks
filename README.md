...
This is demo for use nestjs event emitter and scheduler

## pre-request

```shell
yarn add @nestjs/event-emiitter @nestjs/schedule
yarn add -D @types/cron
```

## with EmitterEvent we could decouple the logic by event
...
## with SchedulerRegistry could dynamic add Timeout/interval/cronjob
